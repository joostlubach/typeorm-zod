...
export function primary(base: z.ZodType = z.int().positive(), options?: PrimaryColumnOptions) {
  ...
  return type as PrimaryColumn<any>
}

function generated<T extends PrimaryColumn<any>>(this:T, options?: PrimaryGeneratedColumnOptions): T
function generated<T extends PrimaryColumn<any>>(this:T, strategy: 'increment' | 'uuid', options?: PrimaryGeneratedColumnOptions): T
...
export type PrimaryColumn<T> = z.ZodType<T> & {
